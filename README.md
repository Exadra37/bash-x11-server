...
Check [Milestones](https://gitlab.com/exadra37-bash/x11-server/milestones) to see what Goals I want to achieve.

Watch [Boards](https://gitlab.com/exadra37-bash/x11-server/boards) to keep track of what is going on.
